...
<style lang="scss">
  @font-face {
    ...
    url("/Source_Sans_Pro/Light.woff2") format("woff2"),
    url("/Source_Sans_Pro/Light.woff") format("woff");
  }
  ...
  @font-face {
    ...
    url("/Source_Sans_Pro/Regular.woff2") format("woff2"),
    url("/Source_Sans_Pro/Regular.woff") format("woff");
  ...
  @font-face {
    ...
    url("/Source_Sans_Pro/SemiBold.woff2") format("woff2"),
    url("/Source_Sans_Pro/SemiBold.woff") format("woff");
  }
  ...
  @font-face {
    ...
    url("/Source_Sans_Pro/Bold.woff2") format("woff2"),
    url("/Source_Sans_Pro/Bold.woff") format("woff");
  }
